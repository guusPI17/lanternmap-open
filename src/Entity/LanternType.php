...
use App\Repository\LanternTypeRepository;
use Doctrine\Common\Collections\ArrayCollection;
use Doctrine\Common\Collections\Collection;
use Doctrine\ORM\Mapping as ORM;

/**
 * @ORM\Entity(repositoryClass=LanternTypeRepository::class)
 */
class LanternType
{
    /**
    ...
    /**
     * @ORM\OneToMany(targetEntity=Lantern::class, mappedBy="type", orphanRemoval=true)
     */
    private $lanterns;
    ...
    public function removeLantern(Lantern $lantern): self
    {
        if ($this->lanterns->removeElement($lantern)) {
            ...
            if ($lantern->getType() === $this) {
                $lantern->setType(null);
            }
        }
